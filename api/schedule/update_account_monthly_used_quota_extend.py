...
def update_account_monthly_used_quota_extend():
    click.echo(click.style("Start 重置账号月额度", fg="green"))
    ...
    click.echo(click.style("重置账号月额度：success latency: {}".format(end_at - start_at), fg="green"))